...
module bd_efdb_0
   (areset,
    ...
    txusrclk,
    txusrclk2);
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.ARESET RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.ARESET, POLARITY ACTIVE_HIGH" *) input areset;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.ARESET_CORECLK RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.ARESET_CORECLK, POLARITY ACTIVE_HIGH" *) input areset_coreclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CORECLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CORECLK, CLK_DOMAIN bd_efdb_0_coreclk, FREQ_HZ 156250000, PHASE 0.000" *) input coreclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.DCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.DCLK, CLK_DOMAIN bd_efdb_0_dclk, FREQ_HZ 100000000, PHASE 0.000" *) input dclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.GTRXRESET RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.GTRXRESET, POLARITY ACTIVE_HIGH" *) input gtrxreset;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.GTTXRESET RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.GTTXRESET, POLARITY ACTIVE_HIGH" *) input gttxreset;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rx TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rx, FREQ_HZ 156250000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 0, HAS_TSTRB 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1" *) output [63:0]m_axis_rx_tdata;
  ...
  input qpll0lock;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.QPLL0OUTCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.QPLL0OUTCLK, CLK_DOMAIN bd_efdb_0_qpll0outclk, FREQ_HZ 100000000, PHASE 0.000" *) input qpll0outclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.QPLL0OUTREFCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.QPLL0OUTREFCLK, CLK_DOMAIN bd_efdb_0_qpll0outrefclk, FREQ_HZ 156250000, PHASE 0.000" *) input qpll0outrefclk;
  output qpll0reset;
  input reset_counter_done;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.RESET_TX_BUFG_GT RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RESET_TX_BUFG_GT, POLARITY ACTIVE_HIGH" *) output reset_tx_bufg_gt;
  ...
  input rxn;
  input rxp;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXRECCLK_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXRECCLK_OUT, CLK_DOMAIN bd_efdb_0_xpcs_0_rxrecclk_out, FREQ_HZ 156250000, PHASE 0.000" *) output rxrecclk_out;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_pause TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_pause, FREQ_HZ 156250000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 0, HAS_TSTRB 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [15:0]s_axis_pause_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_pause TVALID" *) input s_axis_pause_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_tx TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_tx, FREQ_HZ 156250000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1" *) input [63:0]s_axis_tx_tdata;
  ...
  output txn;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.TXOUTCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.TXOUTCLK, CLK_DOMAIN bd_efdb_0_xpcs_0_txoutclk, FREQ_HZ 312500000, PHASE 0.000" *) output txoutclk;
  output txp;
  input txuserrdy;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.TXUSRCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.TXUSRCLK, CLK_DOMAIN bd_efdb_0_txusrclk, FREQ_HZ 312500000, PHASE 0.000" *) input txusrclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.TXUSRCLK2 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.TXUSRCLK2, ASSOCIATED_ASYNC_RESET rx_axis_aresetn:tx_axis_aresetn, ASSOCIATED_BUSIF m_axis_rx:s_axis_pause:s_axis_tx, CLK_DOMAIN bd_efdb_0_txusrclk2, FREQ_HZ 156250000, PHASE 0.000" *) input txusrclk2;
  ...
  wire xpcs_drp_req;
  wire xpcs_qpll0reset;
  wire xpcs_reset_tx_bufg_gt;
  ...
  assign qpll0reset = xpcs_qpll0reset;
  assign reset_counter_done_1 = reset_counter_done;
  assign reset_tx_bufg_gt = xpcs_reset_tx_bufg_gt;
  ...
  bd_efdb_0_xpcs_0 xpcs
       (.areset(areset_1),
        ...
        .qpll0reset(xpcs_qpll0reset),
        .reset_counter_done(reset_counter_done_1),
        .reset_tx_bufg_gt(xpcs_reset_tx_bufg_gt),
