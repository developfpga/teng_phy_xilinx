...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv \
  $QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv \
  $QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv \
  $QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv \
  $QSYS_SIMDIR/xcvr_reset.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
